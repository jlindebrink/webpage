...
<head> 
  <title><?php wp_title('&laquo;', true, 'right'); ?> <?php bloginfo('name'); ?></title>   
    <meta name="description" content="Josefin Lindebrink is an acoustician who specializes in room acoustical prepartion, virtual acoustics modeling, and  auralization.">
    <meta name="keywords" content="auralization, acoustic mapping, acoustics, psychoacoustics"> 
